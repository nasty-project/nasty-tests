...
async def main():
    ...
    if args.only_security and args.only_block_persistence:
        parser.error("--only-security cannot be combined with --only-block-persistence")
